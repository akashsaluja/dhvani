...
"""
    ...
    The code is sourced from https://github.com/westparkcom/Python-Bing-TTS.git
...
class Translator(object):
    ...
    def speak(self, text, lang, gender, format):
        ...
        body = "<speak version='1.0' xml:lang='%s'><voice xml:lang='%s' xml:gender='%s' name='%s'><prosody rate='-20%%'>%s</prosody></voice></speak>" % (lang, lang, gender, servicename, text)
        
        return self.call(headers, "synthesize", body.encode('utf-8'))
